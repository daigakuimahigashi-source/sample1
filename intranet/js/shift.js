...
const DEFAULT_STAFF = [
    // ===== 正社員・マネージャー =====
    { id:'okk10001', name:'又吉 達朗',   salaryType:'monthly', salary:500000, birthdate:'1985-04-12', fixedStore:'', unavailableDays:[], notes:'店舗管理者・フレキシブル配置',
      skills:['肉場','サラダ場','ドリンカー','ホール（肉焼ける）','締め作業','開店作業','レジ'], unavailableDates:[], unavailableSlots:[], restrictions:{noSocialInsurance:false} },
    { id:'okk10003', name:'又吉 健太',   salaryType:'monthly', salary:300000, birthdate:'1992-08-25', fixedStore:'matsuyama', unavailableDays:['水'], notes:'正社員・松山担当',
      skills:['肉場','ホール（肉焼ける）','締め作業','開店作業','レジ'], unavailableDates:[], unavailableSlots:[], restrictions:{noSocialInsurance:false} },
    { id:'okk10004', name:'新城 優樹',   salaryType:'monthly', salary:300000, birthdate:'1994-02-14', fixedStore:'kumoji', unavailableDays:['木'], notes:'正社員・久茂地担当',
      skills:['肉場','サラダ場','ホール（肉焼ける）','締め作業','開店作業'], unavailableDates:[], unavailableSlots:[], restrictions:{noSocialInsurance:false} },
    { id:'okk10005', name:'三澤 北斗',   salaryType:'monthly', salary:300000, birthdate:'1996-11-03', fixedStore:'', unavailableDays:['火'], notes:'正社員',
      skills:['サラダ場','ドリンカー','ホール（肉焼ける）','締め作業','開店作業','レジ'], unavailableDates:[], unavailableSlots:[], restrictions:{noSocialInsurance:false} },
    // ===== 外国籍スタッフ（月給） =====
    { id:'okk10006', name:'チャン フーダット',              salaryType:'monthly', salary:250000, birthdate:'1998-06-20', fixedStore:'', unavailableDays:[], notes:'在留資格確認要',
      skills:['肉場','サラダ場','洗い場'], unavailableDates:[], unavailableSlots:[], restrictions:{noSocialInsurance:false} },
    { id:'okk10021', name:'アルス アーラツチゲーダヌカラクシヤ', salaryType:'monthly', salary:250000, birthdate:'2000-03-15', fixedStore:'', unavailableDays:[], notes:'在留資格確認要',
      skills:['肉場','洗い場'], unavailableDates:[], unavailableSlots:[], restrictions:{noSocialInsurance:false} },
    { id:'okk10022', name:'アマラシンガ ガンガナートアマラ',    salaryType:'monthly', salary:250000, birthdate:'1999-09-08', fixedStore:'', unavailableDays:[], notes:'在留資格確認要',
      skills:['サラダ場','洗い場'], unavailableDates:[], unavailableSlots:[], restrictions:{noSocialInsurance:false} },
    { id:'okk10024', name:'ラナシンガ チャミルシャーニカラッタナ', salaryType:'monthly', salary:250000, birthdate:'2001-01-22', fixedStore:'', unavailableDays:[], notes:'在留資格確認要',
      skills:['肉場','サラダ場','洗い場'], unavailableDates:[], unavailableSlots:[], restrictions:{noSocialInsurance:false} },
    { id:'okk10028', name:'アングルガハ ガマゲー インディカ',   salaryType:'monthly', salary:250000, birthdate:'1997-07-30', fixedStore:'', unavailableDays:[], notes:'在留資格確認要',
      skills:['洗い場','ホール（肉焼けない）'], unavailableDates:[], unavailableSlots:[], restrictions:{noSocialInsurance:false} },
    { id:'okk10037', name:'ウェルガマ ラーララゲ ランドゥニ',   salaryType:'monthly', salary:250000, birthdate:'2002-05-11', fixedStore:'', unavailableDays:[], notes:'在留資格確認要',
      skills:['サラダ場','ドリンカー','洗い場'], unavailableDates:[], unavailableSlots:[], restrictions:{noSocialInsurance:false} },
    { id:'okk10038', name:'ウェラコーン ムディヤンセラーゲ ラヒル', salaryType:'monthly', salary:250000, birthdate:'2003-12-05', fixedStore:'', unavailableDays:[], notes:'在留資格確認要',
      skills:['肉場','洗い場'], unavailableDates:[], unavailableSlots:[], restrictions:{noSocialInsurance:false} },
    { id:'okk10048', name:'アディカーリ ムディアンセラーゲ アヌーシャ', salaryType:'monthly', salary:250000, birthdate:'2001-08-19', fixedStore:'', unavailableDays:[], notes:'在留資格確認要',
      skills:['ホール（肉焼けない）','洗い場','レジ'], unavailableDates:[], unavailableSlots:[], restrictions:{noSocialInsurance:false} },
    // ===== アルバイト（時給1150円） =====
    { id:'okk10008', name:'安里 茜 マーティン', salaryType:'hourly', salary:1150, birthdate:'1998-03-27', fixedStore:'', unavailableDays:['月','火'], notes:'',
      skills:['ホール（肉焼ける）','ドリンカー','レジ'], unavailableDates:[], unavailableSlots:[], restrictions:{noSocialInsurance:false} },
    { id:'okk10002', name:'又吉 未愉',   salaryType:'hourly', salary:1150, birthdate:'2000-10-01', fixedStore:'', unavailableDays:['水','木'], notes:'',
      skills:['ホール（肉焼ける）','レジ','開店作業'], unavailableDates:[], unavailableSlots:[], restrictions:{noSocialInsurance:false} },
    { id:'okk10007', name:'大城 未琴',   salaryType:'hourly', salary:1150, birthdate:'2002-06-18', fixedStore:'', unavailableDays:['土'], notes:'',
      skills:['ホール（肉焼けない）','ドリンカー','洗い場'], unavailableDates:[], unavailableSlots:[], restrictions:{noSocialInsurance:true} },
    { id:'okk10009', name:'平田 明久',   salaryType:'hourly', salary:1150, birthdate:'1999-12-09', fixedStore:'', unavailableDays:[], notes:'',
      skills:['肉場','ホール（肉焼ける）','締め作業'], unavailableDates:[], unavailableSlots:[], restrictions:{noSocialInsurance:false} },
    { id:'okk10010', name:'宮城 文弥',   salaryType:'hourly', salary:1150, birthdate:'2001-04-22', fixedStore:'', unavailableDays:['日'], notes:'',
      skills:['サラダ場','ドリンカー','ホール（肉焼けない）'], unavailableDates:[], unavailableSlots:[], restrictions:{noSocialInsurance:true} },
    { id:'okk10011', name:'大嶺 華笑',   salaryType:'hourly', salary:1150, birthdate:'2003-08-14', fixedStore:'', unavailableDays:['月'], notes:'',
      skills:['ホール（肉焼けない）','洗い場'], unavailableDates:[], unavailableSlots:['遅番'], restrictions:{noSocialInsurance:false} },
    { id:'okk10012', name:'栄野比 あいみ', salaryType:'hourly', salary:1150, birthdate:'2005-02-28', fixedStore:'', unavailableDays:['火','水'], notes:'学生・テスト期間注意',
      skills:['ホール（肉焼けない）','レジ'], unavailableDates:[], unavailableSlots:['遅番'], restrictions:{noSocialInsurance:false} },
    { id:'okk10013', name:'金城 心渚',   salaryType:'hourly', salary:1150, birthdate:'2004-11-05', fixedStore:'', unavailableDays:[], notes:'',
      skills:['ドリンカー','ホール（肉焼けない）','レジ'], unavailableDates:[], unavailableSlots:[], restrictions:{noSocialInsurance:false} },
    { id:'okk10014', name:'阿波根 啓',   salaryType:'hourly', salary:1150, birthdate:'2000-07-17', fixedStore:'', unavailableDays:['土','日'], notes:'',
      skills:['肉場','サラダ場','洗い場'], unavailableDates:[], unavailableSlots:[], restrictions:{noSocialInsurance:false} },
    { id:'okk10015', name:'桑江 旭',     salaryType:'hourly', salary:1150, birthdate:'1999-05-30', fixedStore:'', unavailableDays:[], notes:'',
      skills:['肉場','ホール（肉焼ける）','開店作業'], unavailableDates:[], unavailableSlots:[], restrictions:{noSocialInsurance:false} },
    { id:'okk10016', name:'又吉 茉紀',   salaryType:'hourly', salary:1150, birthdate:'2006-01-13', fixedStore:'', unavailableDays:['木','金'], notes:'学生・未成年',
      skills:['ホール（肉焼けない）','洗い場'], unavailableDates:[], unavailableSlots:['遅番'], restrictions:{noSocialInsurance:false} },
    { id:'okk10017', name:'岸本 海利',   salaryType:'hourly', salary:1150, birthdate:'2003-09-25', fixedStore:'', unavailableDays:['月'], notes:'',
      skills:['サラダ場','ドリンカー','ホール（肉焼けない）'], unavailableDates:[], unavailableSlots:[], restrictions:{noSocialInsurance:false} },
    // ===== アルバイト（時給1100円） =====
    { id:'okk10018', name:'渡口 来夢',   salaryType:'hourly', salary:1100, birthdate:'2005-06-07', fixedStore:'', unavailableDays:['水','木'], notes:'',
      skills:['ホール（肉焼けない）','洗い場'], unavailableDates:[], unavailableSlots:['遅番'], restrictions:{noSocialInsurance:false} },
    { id:'okk10019', name:'仲地 海斗',   salaryType:'hourly', salary:1100, birthdate:'2004-03-19', fixedStore:'', unavailableDays:[], notes:'',
      skills:['洗い場','ホール（肉焼けない）'], unavailableDates:[], unavailableSlots:[], restrictions:{noSocialInsurance:true} },
    { id:'okk10020', name:'平川 翔',     salaryType:'hourly', salary:1100, birthdate:'2002-12-31', fixedStore:'', unavailableDays:['土'], notes:'',
      skills:['肉場','洗い場'], unavailableDates:[], unavailableSlots:[], restrictions:{noSocialInsurance:false} },
    { id:'okk10023', name:'具志堅 詩苑', salaryType:'hourly', salary:1100, birthdate:'2003-07-04', fixedStore:'', unavailableDays:['日'], notes:'',
      skills:['ドリンカー','ホール（肉焼けない）','レジ'], unavailableDates:[], unavailableSlots:[], restrictions:{noSocialInsurance:false} },
    { id:'okk10026', name:'久場 百花',   salaryType:'hourly', salary:1100, birthdate:'2006-04-20', fixedStore:'', unavailableDays:['月','火'], notes:'学生・未成年',
      skills:['ホール（肉焼けない）','洗い場'], unavailableDates:[], unavailableSlots:['遅番'], restrictions:{noSocialInsurance:false} },
    // ===== アルバイト（時給1000円） =====
    { id:'okk10030', name:'宮城 碧子',   salaryType:'hourly', salary:1000, birthdate:'2007-08-02', fixedStore:'', unavailableDays:['月','水','金'], notes:'学生・未成年',
      skills:['ホール（肉焼けない）','洗い場'], unavailableDates:[], unavailableSlots:['遅番'], restrictions:{noSocialInsurance:false} },
    { id:'okk10031', name:'新里 紫緒那', salaryType:'hourly', salary:1000, birthdate:'2005-11-16', fixedStore:'', unavailableDays:['火','木'], notes:'',
      skills:['ホール（肉焼けない）','レジ'], unavailableDates:[], unavailableSlots:[], restrictions:{noSocialInsurance:true} },
    { id:'okk10032', name:'村田 悠華',   salaryType:'hourly', salary:1000, birthdate:'2004-02-09', fixedStore:'', unavailableDays:[], notes:'',
      skills:['サラダ場','ドリンカー','ホール（肉焼けない）'], unavailableDates:[], unavailableSlots:[], restrictions:{noSocialInsurance:false} },
    { id:'okk10033', name:'糸満 苺莉愛', salaryType:'hourly', salary:1000, birthdate:'2006-09-23', fixedStore:'', unavailableDays:['土','日'], notes:'',
      skills:['ホール（肉焼けない）','洗い場'], unavailableDates:[], unavailableSlots:['遅番'], restrictions:{noSocialInsurance:false} },
    { id:'okk10034', name:'知念 あおい', salaryType:'hourly', salary:1000, birthdate:'2003-05-14', fixedStore:'', unavailableDays:['水'], notes:'',
      skills:['ドリンカー','ホール（肉焼けない）','レジ'], unavailableDates:[], unavailableSlots:[], restrictions:{noSocialInsurance:true} },
    { id:'okk10036', name:'當山 健人',   salaryType:'hourly', salary:1000, birthdate:'2002-10-28', fixedStore:'', unavailableDays:[], notes:'',
      skills:['肉場','サラダ場','洗い場'], unavailableDates:[], unavailableSlots:[], restrictions:{noSocialInsurance:false} },
    { id:'okk10040', name:'金城 綾華',   salaryType:'hourly', salary:1000, birthdate:'2005-03-07', fixedStore:'', unavailableDays:['木','金'], notes:'',
      skills:['ホール（肉焼けない）','洗い場'], unavailableDates:[], unavailableSlots:[], restrictions:{noSocialInsurance:true} },
    { id:'okk10041', name:'下地 美弥',   salaryType:'hourly', salary:1000, birthdate:'2007-01-31', fixedStore:'', unavailableDays:['月','火','水'], notes:'学生・未成年',
      skills:['ホール（肉焼けない）'], unavailableDates:[], unavailableSlots:['遅番'], restrictions:{noSocialInsurance:false} },
    { id:'okk10042', name:'池原 幸輝',   salaryType:'hourly', salary:1000, birthdate:'2004-07-19', fixedStore:'', unavailableDays:['日'], notes:'',
      skills:['肉場','洗い場'], unavailableDates:[], unavailableSlots:[], restrictions:{noSocialInsurance:false} },
    { id:'okk10043', name:'譜久里 光流', salaryType:'hourly', salary:1000, birthdate:'2003-04-06', fixedStore:'', unavailableDays:[], notes:'',
      skills:['サラダ場','ホール（肉焼けない）','レジ'], unavailableDates:[], unavailableSlots:[], restrictions:{noSocialInsurance:false} },
    { id:'okk10044', name:'知念 稚奈',   salaryType:'hourly', salary:1000, birthdate:'2006-06-15', fixedStore:'', unavailableDays:['月'], notes:'',
      skills:['ホール（肉焼けない）','洗い場'], unavailableDates:[], unavailableSlots:['遅番'], restrictions:{noSocialInsurance:false} },
    { id:'okk10045', name:'サリバン 莉愛', salaryType:'hourly', salary:1000, birthdate:'2005-10-10', fixedStore:'', unavailableDays:['水','木'], notes:'',
      skills:['ドリンカー','ホール（肉焼けない）'], unavailableDates:[], unavailableSlots:[], restrictions:{noSocialInsurance:true} },
    { id:'okk10046', name:'安仁屋 匠冴', salaryType:'hourly', salary:1000, birthdate:'2002-08-24', fixedStore:'', unavailableDays:[], notes:'',
      skills:['肉場','サラダ場','締め作業'], unavailableDates:[], unavailableSlots:[], restrictions:{noSocialInsurance:false} },
    { id:'okk10047', name:'川満 航希',   salaryType:'hourly', salary:1000, birthdate:'2001-12-17', fixedStore:'', unavailableDays:['火'], notes:'',
      skills:['ホール（肉焼ける）','ドリンカー','洗い場'], unavailableDates:[], unavailableSlots:[], restrictions:{noSocialInsurance:false} },
];
